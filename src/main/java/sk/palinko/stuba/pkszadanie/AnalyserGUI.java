...
public class AnalyserGUI extends javax.swing.JFrame {
    ...
    private void fileChooseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fileChooseActionPerformed
        ...
        if (jCheckBox1.isSelected()) {
            DataTypeHelper.portFilePath = "F:\\Moje dokumenty\\Martin HUdec\\škola\\FIIT\\4. sem\\PKS\\Zadanie1PksXhudecm1\\src\\main\\java\\files\\ports.txt";
        } else {
            DataTypeHelper.portFilePath = "F:\\Moje dokumenty\\Martin HUdec\\škola\\FIIT\\4. sem\\PKS\\Zadanie1PksXhudecm1\\src\\main\\java\\files\\portsSchool.txt";
        }
