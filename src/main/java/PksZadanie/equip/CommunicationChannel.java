...
public class CommunicationChannel {
    ...
    public void checkCompleted() {
        ...
        for (Frame temp : tcpCommList) {
            ...
            } else if (DataTypeHelper.getTcpPortFlags(temp).contains("FIN") && DataTypeHelper.getTcpPortFlags(temp).contains("ACK") && foundFin3.equals(0)) {
                foundFin3 = 1;
                if (srcPfin3 == 0) {
            ...
            } else if (DataTypeHelper.getTcpPortFlags(temp).contains("FIN") && DataTypeHelper.getTcpPortFlags(temp).contains("ACK") && foundFin4.equals(0)) {
                foundFin4 = 1;
                if (srcPfin4 == 0) {
                    srcPfin4 = temp.getIpv4parser().getTcpParser().getSourcePort();
                }
                // System.out.println("nasiel som FIN a ACK");
            } else if (DataTypeHelper.getTcpPortFlags(temp).contains("ACK") && foundFin4.equals(1) && !finOK4.equals(1) && !finOKK4.equals(1)) {
        ...
        if ((open.equals(1) && (close3.equals(1) || close4.equals(1))) || rst > 0) {
            completed = 1;
            if (rst > 0) {
